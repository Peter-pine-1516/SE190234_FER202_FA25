      ...
      <Row className="justify-content-md-center">
        <Col xs={12} md={6}>
          <Card>
            ...
            <Card.Body>
              {/* Hiển thị lỗi từ AuthContext với icon và style phổ biến */}
              {error && (
                <Alert 
                  variant="danger" 
                  className="mb-3 d-flex align-items-center login-error-alert" 
                  onClose={clearError} 
                  dismissible
                >
              ...
              <Form onSubmit={handleSubmit} noValidate>
                ...
                <Form.Group controlId="identifier" className="mb-3">
                  <Form.Label className="text-start d-block">Username or Email</Form.Label>
                  <Form.Control
                    type="text"
                    name="identifier"
